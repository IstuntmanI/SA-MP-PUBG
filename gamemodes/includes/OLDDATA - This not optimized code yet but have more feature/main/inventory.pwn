...
hook OnGameModeInit()
{
	...
	for (new i; i < MAX_RIGHT_MENU_ROWS; i++)
	{
		...
		menuTextDraw[menuTextDrawCount] = TextDrawCreate(257.000000, (163.000000 + (i * 22.000000)), "_");
		...
		menuTextDraw[menuTextDrawCount] = TextDrawCreate(260.000000, (163.000000 + (i * 22.000000)), "Item_model");
